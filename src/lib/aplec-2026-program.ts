...
Amb les alcaldies i Consells de Poble del territori i municipis propers. Amb l'expertesa de Lara Torres, Anna Brunsó, Ousman Jangana, Ismael Peña i Oscar Gussinyer.` },
  ...
  },
  {
    ...
    activities: [
      { time: "10.00 h", title: "Caminada popular sobre biodiversitat i plantes aromàtiques del territori", moreInfo: "Que la gent busqui un espai sobre el terreny que li agradi. S'acaba amb una olfacció.", registration: {
